...
export default function Sidebar({ isOpen, toggleSidebar }) {
  ...
  // Track if screen is mobile size or not
  ...
  return (
    <motion.div
      ...
      className={`fixed top-0 left-0 h-full w-64
        backdrop-blur-lg bg-gray-900/70 text-white p-5 z-50
    ...
    >
      ...
      <nav className="flex flex-col gap-2">
        ...
        <Link
          to="/create-classroom"
          className={linkClasses("/create-classroom")}
        ...
        <Link
          to="/create-teacher"
          className={linkClasses("/create-teacher")}
          onClick={toggleSidebar}
        >
        ...
        <Link
          to="/create-student"
          className={linkClasses("/create-student")}
          onClick={toggleSidebar}
        >

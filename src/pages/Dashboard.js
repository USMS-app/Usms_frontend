  ...
  return (
    <div className="p-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
        <Link
          to="/classrooms"
          className="bg-gradient-to-br from-purple-600 to-indigo-600 p-6 rounded-xl shadow-lg text-white hover:opacity-90 transition block"
        >
        ...
        <Link
          to="/teachers"
          className="bg-gradient-to-br from-pink-500 to-red-500 p-6 rounded-xl shadow-lg text-white hover:opacity-90 transition block"
        >
        ...
        <Link
          to="/students"
          className="bg-gradient-to-br from-green-500 to-teal-500 p-6 rounded-xl shadow-lg text-white hover:opacity-90 transition block"
        >
